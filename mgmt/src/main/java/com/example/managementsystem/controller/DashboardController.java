...
public class DashboardController {
    ...
    private List<CaseInfo> loadAllCasesByStation(String station) {
        ...
        int pageNum = 1; int pageSize = 100; while (true) {
            Map<String,Object> page = caseInfoService.getCasePage(null,null,null,null,null,null,null,null,station,pageNum,pageSize,null,null,null);
            if (page == null) { break; }
    ...
    private List<CaseInfo> loadAllCasesByUser(Long userId) {
        List<CaseInfo> all = new ArrayList<>();
        int pageNum = 1; int pageSize = 100; while (true) {
            Map<String,Object> page = caseInfoService.getCasePage(null,null,null,null,null,null,null,null,null,pageNum,pageSize,null,null,null);
            if (page == null) { break; }
            @SuppressWarnings("unchecked") List<CaseInfo> records = (List<CaseInfo>) page.get("records");
            if (records == null || records.isEmpty()) { break; }
